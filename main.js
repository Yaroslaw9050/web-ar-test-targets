...
//light is needed when we use 3D objects (δεν χρειάζεται το φως)
  ...
  const geometry1 = new THREE.PlaneGeometry(1, 1084/1920);
  ...
  const geometry2 = new THREE.PlaneGeometry(1, 1084/1920);
  ...
  const geometry3 = new THREE.PlaneGeometry(1, 1084/1920);
